...
public class ObjectMother {
    ...
    static final Motion SECOND_MOTION = new Motion("second", "plenaryA", "2024-01-01", 1, "NL Title 2", "FR Title 2", "2459/1-2", "De tweede", "Le deuxieme", createVoteCount());
    ...
    static final Motion FOURTH_MOTION = new Motion("fourth", "plenaryB", "2024-01-03", 1, "NL Title 4", "FR Title 4", "2459/1-4", "De vierde", "Le quatrieme", createVoteCount());
